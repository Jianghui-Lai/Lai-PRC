		...
		b.group(work)
			...
			.handler(new ChannelInitializer<SocketChannel>() {
						...
						protected void initChannel(SocketChannel ch) throws Exception {
							...
							ch.pipeline().addLast(new StringDecoder());//StringDecoder
							ch.pipeline().addLast(new StringEncoder());//StringEncoder
							ch.pipeline().addLast(new SimpleClientHandler());//ClientHandler
						}
			});
